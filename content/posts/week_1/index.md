...
+++
<p>Ideally, a tinkering space is one that provides necessary tools, resources and a comfortable place to work in.</p>
<p>My adventures in the wild:</p>
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 40px;">
    <div style="width: 48%;">
        <img src="ws_1.jpeg" style="width: 100%; border-radius: 10px;">
    </div>
    <div style="width: 48%;">
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 40px;">
    ...
    <div style="width: 48%;">
        <img src="ws_2.jpeg" style="width: 100%; border-radius: 10px;">
    </div>
</div>
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 40px;">
    <div style="width: 48%;">
        <img src="ws_4.jpeg" style="width: 100%; height: 250px; object-fit: cover; border-radius: 10px;">
    </div>
    <div style="width: 45%;">
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 40px;">
    ...
    <div style="width: 48%;">
        <img src="ws_6.jpeg" style="width: 100%; border-radius: 10px;">
    </div>
</div>
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 40px;">
    <div style="width: 48%;">
        <img src="ws_8.jpeg" style="width: 100%; border-radius: 10px;">
    </div>
    <div style="width: 48%;">
